...
class FinancialPlanTest extends TestCase
{
    ...
    public function test_plans_only_shows_own_records(): void
    {
        ...
        FinancialPlan::create(['user_id' => $user->id, 'budget_tracking_id' => $this->getBT($user)->id, 'name' => 'My Plan', 'start_date' => '2024-01-01', 'status' => 'active']);
        FinancialPlan::create(['user_id' => $other->id, 'budget_tracking_id' => $this->getBT($other)->id, 'name' => 'Other Plan', 'start_date' => '2024-01-01', 'status' => 'active']);
